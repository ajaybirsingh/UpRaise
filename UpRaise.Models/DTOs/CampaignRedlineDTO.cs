...
{
    public class CampaignRedlineDTO
    {
        public CampaignRedlineDTO()
        {
        }
        ...
        public IEnumerable<CampaignRedlineCommentDTO> Comments { get; set; }
        public IEnumerable<CampaignRedlineEventDTO> Events { get; set; }
