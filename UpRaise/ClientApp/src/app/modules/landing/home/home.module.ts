...
import { LandingHomeCommonModule } from './home.common.module';

@NgModule({
    declarations: [
    ],
    imports     : [
        LandingHomeCommonModule,
...
@NgModule({
    ...
    imports: [
        LandingHomeCommonModule,
        RouterModule.forChild(landingHomeRoutesSEO),
    ]
})
export class LandingHomeSEOModule {
}
