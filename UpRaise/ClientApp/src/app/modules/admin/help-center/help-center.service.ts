...
import { FaqCategory, Guide, GuideCategory } from 'app/modules/admin/help-center/help-center.type';
...
export class HelpCenterService
{
    ...
    support(supportRequestDTO: { subject: string; message: string}): Observable<any> {
        return this._httpClient.post('api/help-center/support', supportRequestDTO);
    }
}
